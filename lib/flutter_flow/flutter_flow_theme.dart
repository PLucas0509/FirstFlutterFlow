...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color lightGrey = Color(0xFFBBBBBB);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color prussianBlue = Color(0xFF76A0CE);
  late Color marigold = Color(0xFFFECD89);
  late Color turquoiseGreen = Color(0xFFD2EDDF);
  late Color cerise = Color(0xFFF0A9B8);
  late Color fireOpal = Color(0xFFF7B8B4);
  late Color lightGrey = Color(0xFFBBBBBB);
}
